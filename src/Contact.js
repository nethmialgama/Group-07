...
function Contact() {
  ...
  return (
    <div className="page-container" style={{ paddingTop: "0" }}>
      ...
      <div className="contact-card form-card" style={{ maxWidth: "700px", margin: "0 auto 40px auto" }}>
      ...
      {/* ===== 4. CONTACT DETAILS (Address + Info + Social) ===== */}
      <div className="contact-details-section" style={{ maxWidth: "700px", margin: "0 auto 40px auto" }}>
        ...
        <div className="contact-card info-card" style={{ marginTop: "20px" }}>
      ...
      {/* ===== 5. MAP (BOTTOM) ===== */}
      <div className="map-container" style={{ maxWidth: "700px", margin: "0 auto 40px auto" }}>
        <iframe
          title="Colombo Map"
